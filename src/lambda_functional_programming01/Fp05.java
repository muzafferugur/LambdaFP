...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.print(ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 75)); // true
        System.out.println();
        System.out.print(herhangiBirKursAdiKelimeyiIceriyorMu(coursesList, "X")); // false
        System.out.println();
        System.out.print(ortalamasiEnYuksekKursunAdiniYazdir(coursesList)); // Turkish Night
        System.out.println();
